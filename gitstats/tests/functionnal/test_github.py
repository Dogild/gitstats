...
class GithubTests(TestCase):
    ...
    def test_contributions_five_days(self):
        ...
        contributions_05_05 = sorted(contributions[1], key=lambda contribution: contribution.date)
        ...
        contributions_06_05 = sorted(contributions[2], key=lambda contribution: contribution.date)
        ...
        contributions_07_05 = sorted(contributions[3], key=lambda contribution: contribution.date)
        ...
        contributions_08_05 = sorted(contributions[4], key=lambda contribution: contribution.date)
        ...
        contributions_09_05 = sorted(contributions[5], key=lambda contribution: contribution.date)
